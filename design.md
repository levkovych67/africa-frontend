...
| Logo | `/images/new logo.PNG`, `h-8 w-auto` |
...
| Desktop image | `/images/pc hero.png`, `object-cover` |
| Mobile image | `/images/phone.png`, `object-cover`, `loading="eager"` |
...
| Path | Description |
|------|-------------|
| `/images/new logo.PNG` | AFRICA logo — geometric polygonal Africa continent + text |
| `/images/pc hero.png` | Desktop hero background |
| `/images/phone.png` | Mobile hero background |
